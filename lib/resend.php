 ...
 *
 * The SMTP/PHPMailer path (lib/mailer.php) is still used for admin
 * invite/reset mail; the public contact form uses Resend instead. Both read
 * their secrets from lib/config.php (env-driven).
 *
 ...
 */
function resend_send($subject, $html, $replyTo = null) {
  if (RESEND_API_KEY === '') {
  ...
  curl_setopt_array($ch, [
    ...
    CURLOPT_TIMEOUT        => 8,   // keep in step with the SMTP timeout in mailer.php
    CURLOPT_HTTPHEADER     => [
